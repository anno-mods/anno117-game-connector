...
int SetupImgui(HWND& hwnd, WNDCLASSEXW& wc)
{
    ...
    ::RegisterClassExW(&wc);
    hwnd = ::CreateWindowW(wc.lpszClassName, L"Anno 117 Pipe Example", WS_OVERLAPPEDWINDOW, 100, 100, (int)(1280 * main_scale), (int)(800 * main_scale), nullptr, nullptr, wc.hInstance, nullptr);
...
void CleanupImgui(HWND hWnd, WNDCLASSEXW wc)
{
